    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(default='全国知名', max_length=5, verbose_name='机构标签')),
                ('category', models.CharField(choices=[('pxjg', '培训结构'), ('gr', '个人'), ('gx', '高校')], default='gx', max_length=20, verbose_name='机构类别')),
